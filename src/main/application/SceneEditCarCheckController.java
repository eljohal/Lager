...
public class SceneEditCarCheckController {
	...
	public Scene scene;
	public Parent root;
	SceneEditCarController sceneCarPartsController;
	@FXML 
	Button back;
	@FXML
	Button add;
	...
	public void sceneGeneralSettings(SceneEditCarController controller) {
	...
	public void addCar() throws IOException {
		...
		sceneCarPartsController.versionEditCarCheck.pauseThread();
		...
		i_max++;
		changes = "edit";
		MySQLDatenbankConnection.update("UPDATE `cardata` SET `Erstzulassung`='"+zulassung+"',`Fahrgestellnummer`='"+fahrgestellnmr2+"',`Farbcode`='"+farbcode2+"',`Getriebeart`='"+getriebeart2+"',`Getriebecode`='"+getriebecode2+"',`Hersteller`='"+herstell2+"',`Hubraum`='"+hubraum2+"',`Kilometerstand`='"+kilometer2+"',`Kraftstoff`='"+kraft2+"',`Leistung`='"+leistung2+"',`Modell`='"+model2+"',`Motorcode`='"+motorcode2+"',`Türenanzahl`='"+tuer2+"', `version`='"+version+"' WHERE `CarID`='"+carid+"'");
		MySQLDatenbankConnection.update("INSERT INTO `changehistorycar`(`TimeStamp`, `ChangeID`, `CarID`, `UserID`, `Changed`, `Erstzulassung`, `Fahrgestellnummer`, `Farbcode`, `Getriebeart`, `Getriebecode`, `Hersteller`, `Hubraum`, `Kilometerstand`, `Kraftstoff`, `Leistung`, `Modell`, `Motorcode`, `Türrenanzahl`, `version`) VALUES ('"+timestamp+"','"+i_max+"','"+carid+"','"+User.id+"','"+changes+"','" + zulassung + "','" + fahrgestellnmr2 + "','" + farbcode2 + "','" + getriebeart2 + "','" + getriebecode2 + "','" + herstell2 + "','" + hubraum2 + "','" + kilometer2 + "','" + kraft2 + "','" + leistung2 + "','" + model2 + "','" + motorcode2 + "','" + tuer2 + "','" + version + "')");		
